...
util.base64Encode = function(e) {
    ...
    if (wx.showNavigationBarLoading(), a.showLoading && util.showLoading(), a.cachetime) {
        ...
        if (c && c.data) {
            ...
            a.success && "function" == typeof a.success && a.success(c), a.showLoading && wx.hideLoading(), 
            wx.hideNavigationBarLoading(), !0;
    ...
    wx.request((_defineProperty(e = {
        ...
        if (wx.hideNavigationBarLoading(), a.showLoading && wx.hideLoading(), e.data.errno) {
            if ("41009" == e.data.errno) return wx.setStorageSync("userInfo", ""), void util.getUserInfo(function() {
                util.request(a);
            });
            if (a.fail && "function" == typeof a.fail) a.fail(e); else if (console.log(e.data.message), 
            e.data.message && "签名错误" != e.data.message) {
        ...
        wx.hideNavigationBarLoading(), a.showLoading && wx.hideLoading();
